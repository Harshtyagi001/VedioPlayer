...
const updateUserCoverImage=asyncHandler(async(req,res)=>{
  ...
  if(!imageLocalPath)throw new ApiError(400,"Cover Image is missing");
  const coverImage=await uploadOnCloudinary(imageLocalPath);
  if(!coverImage)throw new ApiError(400,"Cover Image is required, issue while uploading on cloudinary")
